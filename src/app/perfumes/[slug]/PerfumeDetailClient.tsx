  ...
  <div className="relative w-full max-w-[260px] sm:max-w-[320px] lg:max-w-[390px] aspect-[3/4] rounded-xl overflow-hidden bg-[#FFF4E3]">
    {perfume.image ? (
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-[72px] py-5 space-y-6 bg-white">
        ...
        <div className={`flex flex-col gap-6 ${isCoolingPeriodActive ? 'opacity-50 pointer-events-none filter grayscale' : ''}`}>
          {/* Section Header */}
        ...
        <div style={{ contentVisibility: 'auto', containIntrinsicSize: '1px 1000px' }} className="-mx-4 sm:-mx-6 lg:-mx-[72px] px-4 sm:px-6 lg:px-[72px] py-5">
          <SimilarFragrances
              ...
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-4 lg:gap-6">
                  ...
                  <button
                    ...
                    className={`inline-flex items-center justify-center h-[40px] px-6 gap-2 border rounded-lg font-inter font-medium text-[16px] leading-[26px] transition-colors ${isFollowing
