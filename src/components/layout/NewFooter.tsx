  ...
  return (
    <footer className="flex flex-col items-center w-full bg-[#FFF9EF]">
      ...
      <div className="w-full flex flex-col items-center pt-10">
        ...
        <div
          className="relative w-full min-h-[400px] rounded-t-[56px] flex flex-col items-start justify-center px-6 sm:px-12 lg:px-[72px] py-16 lg:py-20"
          style={{
        ...
        <div className="w-full h-[72px] bg-[#211F1C] flex items-center overflow-hidden">
          <div className="flex items-center gap-6 animate-scroll whitespace-nowrap">
            ...
            {[...scrollerTexts, ...scrollerTexts, ...scrollerTexts].map((text, idx) => (
      ...
      <div className="relative w-full bg-[#211F1C] overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-12">
            ...
            <div className="flex flex-col sm:flex-row gap-8 lg:gap-[61px]">
              ...
              <div className="flex flex-col gap-5 min-w-[180px] lg:w-[212px]">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="/profile" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    My Profile
                  </Link>
                  <Link href="/wardrobe" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    My Wardrobe
                  </Link>
                  <Link href="/profile/reviews" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    My Reviews
                  </Link>
                  <Link href="/settings" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    Settings
                  </Link>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-5 min-w-[180px] lg:w-[212px]">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="/brands" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    Brands
                  </Link>
                  <Link href="/perfumes" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    Perfumes
                  </Link>
                  <Link href="/drydown" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    Drydown
                  </Link>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-5 min-w-[180px] lg:w-[212px]">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="/contact" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    Contact
                  </Link>
                  <Link href="/submit" className="font-[var(--font-inter)] font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
                    Submit Perfume
                  </Link>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-[26px] lg:w-[290px]">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M4 4L10.5 12.5M20 20L13.5 11.5M10.5 12.5L4 20M10.5 12.5L13.5 11.5M13.5 11.5L20 4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </a>
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <path d="M8 11V16M8 8V8.01M12 16V11M16 16V13C16 11.8954 15.1046 11 14 11C12.8954 11 12 11.8954 12 13" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </a>
              </div>
            </div>
        ...
        {/* Large Fragview Text */}
        <div className="relative w-full flex justify-center overflow-hidden pt-8 sm:pt-10 lg:pt-12 pb-8 lg:pb-12">
          <span className="font-hedvig font-normal text-[80px] sm:text-[150px] lg:text-[200px] xl:text-[275px] leading-none text-white whitespace-nowrap select-none">
            Fragview
          </span>
        </div>
        ...
        <div className="px-6 sm:px-12 lg:px-[72px] py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-inter font-normal text-base leading-6 text-white">
            Copyright © {new Date().getFullYear()} Fragview. All rights reserved.
          </p>
          <div className="relative z-10 flex items-center gap-6">
            <Link href="/terms" className="font-inter font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
              Term of Service
            </Link>
            <Link href="/privacy" className="font-inter font-normal text-base leading-6 text-white hover:text-white/80 transition-colors">
              Privacy Policy
            </Link>
          </div>
        </div>
